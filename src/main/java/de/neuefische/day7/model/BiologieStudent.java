...
public class BiologieStudent implements Student {
    ...
    public BiologieStudent(String firstname, String lastname, int id) {
    ...
    public boolean equals(Object o) {
        ...
        BiologieStudent student = (BiologieStudent) o;
